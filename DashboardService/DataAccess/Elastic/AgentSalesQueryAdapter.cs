...
{
    public class AgentSalesQueryAdapter : QueryAdapter<AgentSalesQuery,AgentSalesQueryResult,OrderInfo>
    {
        ...
        public override SearchRequest<OrderInfo> BuildQuery()
        {
            ...
            var sumAmountAgg = new SumAggregation("total_order_value",new Field("totalOrderValue"));

            var termAgg = new TermsAggregation("agent_count")
            {
                Field = new Field("agentLogin.keyword"),
        ...
        public override AgentSalesQueryResult ExtractResult(ISearchResponse<OrderInfo> searchResponse)
        {
            ...
            {
                var sum = bucket.Sum("total_order_value");
