...
{
    public class TotalSalesQueryAdapter : QueryAdapter<TotalSalesQuery,TotalSalesQueryResult,OrderInfo>
    {
        ...
        public override TotalSalesQueryResult ExtractResult(ISearchResponse<OrderInfo> searchResponse)
        {
