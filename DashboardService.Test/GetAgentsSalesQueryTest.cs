...
namespace DashboardService.Test
{
    ...
    public class GetAgentsSalesQueryTest 
    {
        ...
        {
            var queryHandler = new GetAgentsSalesHandler(new ElasticOrderRepository(fixture.ElasticClient()));
            ...
            result.Should()
                ...
                .And
                .HaveAgentSales("rohit.solid", 6, 630M);
        ...
        public async void Sales_All_Product_By_All_Agents_In_01_And_02_2020()
        {
            ...
            result.Should()
                ...
                .HaveAgentSales("rohit.solid", 6, 630M)
                .And
                .HaveAgentSales("surya.solid", 5, 325M);
