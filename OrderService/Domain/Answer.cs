...
namespace OrderService.Domain
{
    public abstract class Answer
    {
        ...
        public static Answer Create(OrderService.Api.Commands.Dtos.QuestionType questionType, string questionCode, object answerValue)
        {
            switch (questionType)
            {
                case OrderService.Api.Commands.Dtos.QuestionType.Text:
                    return new TextAnswer(questionCode, (string)answerValue);
                case OrderService.Api.Commands.Dtos.QuestionType.Choice:
                    return new ChoiceAnswer(questionCode, (string)answerValue);
                case OrderService.Api.Commands.Dtos.QuestionType.Numeric:
